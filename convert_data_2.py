...
feature_converter(load_relevant_data_subset(os.path.join("data", f'{pd.read_csv(TRAIN_FILE).path[1]}')))
...
def convert_and_save_data():
    ...
    np.save("data/v2/feature_data.npy", npdata)
    np.save("data/v2/feature_labels.npy", nplabels)
